...
import { institutionField } from "../../../network/institution";
...
export default {
  ...
  created: function() {
    institutionField({
      ...
      // console.log(res)
      res.content = res.content.sort((a, b) => a.count - b.count).slice(0, 5);
      this.option.dataset.source = res.content.map(function(a) {
        a.field_id = a.fieldId;
        a.docCount = a.count;
        a.field = a.fieldName;
        return a;
      });
    ...
    //   { field_id: 52, docCount: 2, field: "Operating system" },
    //   { field: "Management science", field_id: 10, docCount: 1 },
    //   { field_id: 57, field: "Civil engineering", docCount: 1 },
    //   { field: "Speech recognition", field_id: 37, docCount: 1 },
    //   { field_id: 48, field: "Computational science", docCount: 1 },
    //   { field: "Electrical engineering", field_id: 39, docCount: 1 }
    // ];
    // this.$refs.bar.updateCharts();
